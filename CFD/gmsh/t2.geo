...
// along the y axis:
newid = Translate {0, 0.1, 0} { Duplicata{ Point{3}; } };
Printf("New id '%g' ", newid);
...
// surfaces):
surfaceId[] = Extrude {0, 0, 0.12} { Surface{my_new_surfs[1]}; };
Printf("new surfaces '%g' ", surfaceId[5]);
